...
**Response**: The distribution is fairly normal because the median and the average are similar. If there were more data points on one side, then the median would not be close to the average. The maximum is most likely an outlier and is skewing the data to the right.
...
**Response**: Engineering has the most range in their salary, minimum of 40,000 and maximum of 110,000. 
