...
``` r
  college_recent_grads %>% 
  summarize(n = n(), avg = mean(median), sd = sd(median), mini = min(median), med = median(median), maxi = max(median))
```

    ## # A tibble: 1 x 6
    ##       n    avg     sd  mini   med   maxi
...
**Response**: The distribution is fairly normal because the median and
the average are similar. If there were more data points on one side,
then the median would not be close to the average. The maximum is most
likely an outlier and is skewing the data to the right.
...
```
    ...
    ## # A tibble: 16 x 7
    ##    major_category                          n    avg     sd  mini   med   maxi
    ##    <chr>                               <int>  <dbl>  <dbl> <dbl> <dbl>  <dbl>
    ##  1 Engineering                            29 57383. 13626. 40000 57000 110000
    ##  2 Computers & Mathematics                11 42745.  5109. 35000 45000  53000
    ##  3 Business                               13 43538.  7774. 33000 40000  62000
    ##  4 Physical Sciences                      10 41890   8252. 35000 39500  62000
    ##  5 Social Science                          9 37344.  4751. 32000 38000  47000
    ##  6 Biology & Life Science                 14 36421.  4529. 26000 36300  45000
    ##  7 Law & Public Policy                     5 42200   9066. 35000 36000  54000
    ##  8 Agriculture & Natural Resources        10 36900   6935. 29000 35000  53000
    ##  9 Communications & Journalism             4 34500   1000  33000 35000  35000
    ## 10 Health                                 12 36825   5776. 28000 35000  48000
    ## 11 Industrial Arts & Consumer Services     7 36343.  7291. 29000 35000  50000
    ## 12 Interdisciplinary                       1 35000     NA  35000 35000  35000
    ## 13 Education                              16 32350   3893. 22000 32750  41000
    ## 14 Humanities & Liberal Arts              15 31913.  3393. 27000 32000  40000
    ## 15 Arts                                    8 33062.  7223. 27000 30750  50000
    ## 16 Psychology & Social Work                9 30100   5382. 23400 30000  40000
...
**Response**: Engineering has the most range in their salary, minimum of
40,000 and maximum of 110,000.
